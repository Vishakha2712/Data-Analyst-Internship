...
### 📩 Task Overview
A denormalized sales dataset was provided.
The task was to convert it into a proper star schema.
...
- Built:
  ...
  - dim_products
  - dim_dates
- Ensured correct primary & foreign keys

### 🛠 Tool Used
- MS Excel

### 📁 Solution Files
- `fact_order_soln.xlsx`
...
### 📩 Task Overview
SQL-based analysis on business datasets to extract insights.
...
- Validated results with expected outputs
